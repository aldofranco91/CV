...
\section{Experiencia}
	 %
\datedexperience{\href{http://strategybigdata.com/index.php/es/}{Strategy Big Data, Madrid, Spain.}}{04/2022 - Actualidad} 
\explanation{Data Scientist en Strategy Big Data}
\explanationdetail{
	\coloredbullet\ Análisis de datos/modelos para clientes relacionados con la minería, hostelería y el sector médico. \\
	\coloredbullet\ Tecnologías utilizadas: Python. \\
}
	 %
	\datedexperience{\href{https://www.gruposolutio.com/}{Grupo Solutio, Madrid, Spain.}}{02/2022 - 04/2022} 
	\explanation{Data Scientist en Banco Santander}
	\explanationdetail{
		\coloredbullet\ Desarrollo de proyectos en R para usuarios avanzados. \\
		\coloredbullet\ Documentación de proyectos. \\
		\coloredbullet\ Tecnologías utilizadas: R y SAS. \\
	}
    %
    \datedexperience{\href{https://www.ncs-spain.com/ncssp/}{Network Centric Software, S.A, Madrid, España.}}{03/2020 - 02/2022} 
    \explanation{Data Scientist en AXA Seguros S.A.}
    \explanationdetail{
     \coloredbullet\  Adquisición de datos de fuentes abiertas y aplicación de técnicas estadísticas, técnicas geoespaciales y algoritmos de aprendizaje automático supervisado (regresión y clasificación) y no supervisado (técnicas de clustering), para resolver problemas comerciales y técnicos con impacto en las prioridades de la empresa. \\
     \coloredbullet\ Técnicas de Inteligencia Artificial para procesamiento de imágenes y NLP. \\
...
\section{Habilidades}
    ...
    %
    \newcommand{\skillthree}{\createskill{Frameworks \ \& \ Librerías}{Jupyter \cpshalf Caret \cpshalf Numpy \cpshalf Pandas \cpshalf Scikit-learn \cpshalf Keras \cpshalf Shiny \cpshalf PyCaret}}
    %
